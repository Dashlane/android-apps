...
) : ItemEditMenuAction(R.string.toolbar_menu_title_secure_note_lock, R.drawable.menu_item_lock_unlock,
        MenuItem.SHOW_AS_ACTION_ALWAYS, true, isSecured, lockMenuAction, lockMenuUpdate)