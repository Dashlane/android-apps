...
public enum TrCodeDesktop {
    ...
    UI_SHARING_ERROR_NON_TRANSACTIONAL_EVENTS_1(R.string.ui_sharing_error_non_transactional_events_1),
    UI_SHARING_ERROR_NON_TRANSACTIONAL_EVENTS_2(R.string.ui_sharing_error_non_transactional_events_2),
