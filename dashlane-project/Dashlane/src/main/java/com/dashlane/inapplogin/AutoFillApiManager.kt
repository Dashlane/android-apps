...
class AutoFillApiManager private constructor(private val context: Context) {
    ...
    companion object {
        ...
        @JvmStatic
        fun createIfPossible(context: Context): AutoFillApiManager? {
            val autoFillApiManager = AutoFillApiManager(context)
            return if (autoFillApiManager.autoFillManager?.isAutofillSupported == true) {
                autoFillApiManager
            } else {
                null
            }
