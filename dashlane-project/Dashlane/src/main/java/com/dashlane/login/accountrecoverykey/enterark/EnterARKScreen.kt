...
fun EnterARKContent(
    ...
    Column(
        ...
        ButtonMedium(
            ...
            layout = if (isLoading) ButtonLayout.IndeterminateProgress else ButtonLayout.TextOnly(text = stringResource(id = R.string.login_account_recovery_key_enter_button))
        )
    }
}
...
@Preview
@Composable
private fun EnterARKContentPreview() {
    DashlanePreview {
        EnterARKContent(
            isLoading = true,
            isError = true,
