...
class OnboardingDarkWebMonitoringNoAlertsFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_onboarding_dark_web_monitoring_no_alerts, container, false)
            .also {
