...
class DarkWebMonitoringLeakedPasswordsAnalysis @Inject constructor(
    ...
    fun extractPasswordMap(detail: DarkWebService.BreachStatusContent.Detail): Map<String, List<String>>? {
        
        val info = getInfoDeciphered(detail) ?: return null
    ...
    private fun getInfoDeciphered(detail: DarkWebService.BreachStatusContent.Detail): String? {
        val cipheredInfo = detail.cipheredInfo ?: return null
        val cipheredKey = detail.cipheredKey ?: return null
