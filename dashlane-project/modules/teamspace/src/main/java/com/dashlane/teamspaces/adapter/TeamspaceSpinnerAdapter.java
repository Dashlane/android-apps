...
public class TeamspaceSpinnerAdapter extends ArrayAdapter<Teamspace> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = getView(position, convertView, parent, R.layout.spinner_item_preview, R.dimen.teamspace_icon_size_edit_selector);
    ...
    private View getView(int position, View convertView, ViewGroup parent, int layoutResId, @DimenRes int iconSizeRes) {
        ...
        if (convertView instanceof TextView) {
            ...
            view = (TextView) LayoutInflater.from(parent.getContext()).inflate(layoutResId, parent, false);
